...
async function run() {
  ...
  assert.match(windowsSupport({ platform: 'win32', arch: 'x64', release: '10.0.22000' }).error, /22H2/);
  ...
  const release = parseRelease({
    tag_name: 'chromux-v0.62.0',
    html_url: 'https://github.com/GeorgeQLe/gblockparty-chromux/releases/tag/chromux-v0.62.0',
    assets: [
      { name: 'GBlockParty-Chromux-Setup-0.62.0-x64.exe', browser_download_url: 'https://example/setup' },
      { name: 'GBlockPartyChromux-0.62.0-full.nupkg', browser_download_url: 'https://example/package' },
