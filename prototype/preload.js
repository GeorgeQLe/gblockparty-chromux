...
contextBridge.exposeInMainWorld('chromux', {
  ...
  vercelOAuthStart: (request) => ipcRenderer.invoke('vercel-oauth-start', request || {}),
  vercelOAuthCancel: () => ipcRenderer.invoke('vercel-oauth-cancel'),
  onVercelOAuthUpdate: (cb) => ipcRenderer.on('vercel-oauth-update', (_e, result) => cb(result)),
  vercelShipPreview: (request) => ipcRenderer.invoke('vercel-ship-preview', request || {}),
  vercelShipStart: (request) => ipcRenderer.invoke('vercel-ship-start', request || {}),
  vercelJobsRead: () => ipcRenderer.invoke('vercel-jobs-read'),
  vercelJobCancel: (id) => ipcRenderer.invoke('vercel-job-cancel', id),
  vercelJobRetry: (id) => ipcRenderer.invoke('vercel-job-retry', id),
  onVercelJobUpdate: (cb) => ipcRenderer.on('vercel-job-update', (_e, job) => cb(job)),
  ...
  windowsSetupStatus: () => ipcRenderer.invoke('windows-setup-status'),
  windowsSetupRefresh: () => ipcRenderer.invoke('windows-setup-refresh'),
  windowsSetupSelectDistro: (distro) => ipcRenderer.invoke('windows-setup-select-distro', distro),
  windowsSetupSaveRoot: (root, create = false) => ipcRenderer.invoke('windows-setup-save-root', { root, create }),
  windowsSetupComplete: () => ipcRenderer.invoke('windows-setup-complete'),
  windowsSetupSelfTest: () => ipcRenderer.invoke('windows-setup-self-test'),
  windowsSetupOpenDocumentation: (key) => ipcRenderer.invoke('windows-setup-open-documentation', key),
  windowsSetupExit: () => ipcRenderer.invoke('windows-setup-exit'),
