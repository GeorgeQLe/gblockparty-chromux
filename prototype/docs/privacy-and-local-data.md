...
| Appearance preference | User chooses a theme in Settings. | Chromium-managed local storage for the Chromux renderer. | The selected theme remains until another theme is chosen or the app profile is cleared. | Not synced or sent by Chromux. |
